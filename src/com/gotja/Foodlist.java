...
public class Foodlist extends Activity{
	...
	private Context context=Foodlist.this;
		...
		new AsyncTask<Void, Void, String>() {
			...
			protected String doInBackground(Void... params) {
				...
				try {
					...
					final HttpPost httppost = new HttpPost("http://120.126.16.38/showfood.php");
			...
			protected void onPostExecute(String result) {
				...
				{ 
					...
					try {
						    ...
						    sn=jsonObject.getString("shopname");
						   // Log.v(log, sn);
						    sa=jsonObject.getString("shopaddress");
						    //Log.v(log, sa);
						    ...
						    //Log.v(log, pic);
						    dish.add(jsonObject.getString("dishname"));
						    //Log.v(log,dish.get(i));
